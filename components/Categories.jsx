         ...
         <div className={styles.content_container}>
          <div className={styles.categories_container}>
            <div className={styles.category_card_container}>
              <div data-aos="zoom-out" className={styles.category_card}>
                {catCategory.map((category) => (
                  <img src={category.image} className={styles.category_img}  key={category.name}/>
                ))}
              </div>
              <div  data-aos="fade-up" className={styles.category_details}>
          ...
          <div className={styles.features_container}>
            <div  data-aos="fade-up" className={styles.features_card}>
                <FontAwesomeIcon
                  icon = {faUser} 
            ...
            <div  data-aos="fade-right" className={styles.features_card}>
                <FontAwesomeIcon
                  icon = {faShoppingCart} 
            ...
            <div  data-aos="fade-left"  className={styles.features_card}>
                <FontAwesomeIcon
                  icon = {faBarChart} 
